...
class ExpConfig:
    ...
    OUTPUT_FILE = "results_ablation_no_guidance.json"
...
if __name__ == "__main__":
    ...
    print("*** RUNNING ABLATION: NO DIRECTIONAL GUIDANCE ***")
    mcts_cfg.W_DIR = 0.0
    # ---------------------------
    ...
    print(f"\n--- Starting Ablation Experiment: No Directional Guidance ---")
